...
{  
    ...
    do
    {
        ...
        {
            case 1: system("cls");
					printf("Ingrese el nombre de archivo de entrada(Escriba el nombre con extension): ");
            ...
            case 2: system("cls");
            		printf("Ingrese el nombre de archivo de salida del cache (Escriba el nombre sin extension): ");
            ...
            case 3: system("cls");
            		elCache(cache,archivoEntrada); //Comienza el llenado del cache, segun la politica que se ingreso
